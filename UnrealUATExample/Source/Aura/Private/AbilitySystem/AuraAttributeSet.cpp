...
#define X(Category,AttributeName) TagsToAttributes.Add(GameplayTags.Attributes_##Category##_##AttributeName, Get##AttributeName##Attribute);
	REPLICATED_ATTRIBUTES_WITH_CATEGORIES
#undef X
}
...
#define X(Category, Attribute) DOREPLIFETIME_CONDITION_NOTIFY(UAuraAttributeSet, Attribute, COND_None, REPNOTIFY_Always);
	REPLICATED_ATTRIBUTES_WITH_CATEGORIES
#undef X
}
...
void UAuraAttributeSet::SetEffectProperties(const FGameplayEffectModCallbackData& Data, FEffectProperties& Props) const
{
	...
	if (
		IsValid(Props.SourceAbilitySystemComponent) &&
	...
	)
	{
		...
		Props.SourceController = Props.SourceAbilitySystemComponent->AbilityActorInfo->PlayerController.
		                               Get();
	...
	if (Data.Target.AbilityActorInfo.IsValid() && Data.Target.AbilityActorInfo->AvatarActor.IsValid())
	{
		...
		Props.TargetAbilitySystemComponent = UAbilitySystemBlueprintLibrary::GetAbilitySystemComponent(
